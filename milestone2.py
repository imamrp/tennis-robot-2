...
def milestone2_process(v_desired, w_desired, center, radius, rotbot_x, robot_y, theta, use_cam, box_distance, left_line_detected, right_line_detected):
    ...
    # servo setup
    PWM_pin = 11
    servo = Servo(PWM_pin,min_pulse_width=0.01, max_pulse_width=0.022,frame_width=0.025)    # min and max pulse width may need to be changed if rom not large enough
