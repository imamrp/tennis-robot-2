...
import detection2, multiprocessing, time, RGBsensor, gpiozero, states
...
def ctrl_gate(servo, open):
    ...
    """
    servo.ChangeDutyCycle(4.0) if open else servo.ChangeDutyCycle(12.0) # Open gate
    sleep(1)
...
def sensor_process(box_distance, left_line_detected, right_line_detected):
    ...
    rgb_sensor = RGBsensor.DualSensorReader(threshold = 200)
