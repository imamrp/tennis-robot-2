...
PWM_pin = 11
servo = Servo(PWM_pin,min_pulse_width=0.001, max_pulse_width=0.0044,frame_width=0.005)    # min and max pulse width may need to be changed if rom not large enough
